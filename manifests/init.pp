...
class raspberrypi_config (
  # General options
  Stdlib::Absolutepath                        $config_file                    = '/boot/config.txt',
  ...
  Varient[Boolean,Integer[0,1],Undef]         $hdmi_blanking_0                = undef,
  ...
  Varient[Boolean,Integer[0,1],Undef]         $hdmi_blanking_1                = undef,
  ...
  Optional[Enum[0,1,2,3,'0x10000','0x20000']] $lcd_rotate                     = undef,
  ...
  Optional[Integer[0]]                        $overscan_left                  = undef,
  ...
  Optional[Enum[0,1,2,3,'0x10000','0x20000']] $display_hdmi_rotate            = undef,
  Optional[Enum[0,1,2,3,'0x10000','0x20000']] $display_lcd_rotate             = undef,
  Optional[Enum[0,1,2,3,'0x10000','0x20000']] $display_rotate                 = undef,
  ...
  Optional[Regexp[/^0x[a-fA-Z\d]{4,8}$/]]     $kernel_address                 = undef,
  Variant[Boolean,Integer[0,1],Undef]         $kernel_old                     = undef,
  Variant[String,Array[String,1],Undef]       $ramfsfile                      = undef,
  Optional[Regexp[/^0x[a-fA-Z\d]{4,8}$/]]     $ramfsaddr                      = undef,
  ...
  $model_type    = $facts['raspberry_pi_model'][ 'model_type'    ]
  $model_version = $facts['raspberry_pi_model'][ 'model_version' ]
